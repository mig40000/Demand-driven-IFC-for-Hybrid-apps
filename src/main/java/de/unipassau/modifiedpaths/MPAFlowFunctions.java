 ...
 */
public class MPAFlowFunctions implements IFlowFunctionMap<BasicBlockInContext<IExplodedBasicBlock>> {
    ...
    public MPAFlowFunctions(CallGraph callGraph, CGNode bridgeNode) {
