...
.method applyToInternal(Landroid/support/constraint/ConstraintLayout;)V
    ...
    .line 778
    iget v3, v6, Landroid/support/constraint/ConstraintSet$Constraint;->mHelperType:I
    ...
    .line 782
    iget-object v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->mReferenceIds:[I

    invoke-virtual {v3, v7}, Landroid/support/constraint/Barrier;->setReferencedIds([I)V

    .line 783
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->mBarrierDirection:I
    ...
    invoke-virtual {v6, v7}, Landroid/support/constraint/ConstraintSet$Constraint;->applyTo(Landroid/support/constraint/ConstraintLayout$LayoutParams;)V
    ...
    .line 795
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->visibility:I
    ...
    .line 797
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->alpha:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setAlpha(F)V

    .line 798
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->rotation:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setRotation(F)V

    .line 799
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->rotationX:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setRotationX(F)V

    .line 800
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->rotationY:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setRotationY(F)V

    .line 801
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->scaleX:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setScaleX(F)V

    .line 802
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->scaleY:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setScaleY(F)V

    .line 803
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->transformPivotX:F
    ...
    .line 806
    :cond_1
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->transformPivotY:F
    ...
    .line 809
    :cond_2
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->translationX:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setTranslationX(F)V

    .line 810
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->translationY:F
    ...
    .line 812
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->translationZ:F

    invoke-virtual {v4, v7}, Landroid/view/View;->setTranslationZ(F)V

    .line 813
    iget-boolean v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->applyElevation:Z

    if-eqz v7, :cond_3

    .line 814
    iget v7, v6, Landroid/support/constraint/ConstraintSet$Constraint;->elevation:F
    ...
    iget v6, v5, Landroid/support/constraint/ConstraintSet$Constraint;->mHelperType:I
    ...
    .line 827
    iget-object v7, v5, Landroid/support/constraint/ConstraintSet$Constraint;->mReferenceIds:[I

    invoke-virtual {v6, v7}, Landroid/support/constraint/Barrier;->setReferencedIds([I)V

    .line 828
    iget v7, v5, Landroid/support/constraint/ConstraintSet$Constraint;->mBarrierDirection:I
    ...
    :cond_6
    :goto_3
    iget-boolean v6, v5, Landroid/support/constraint/ConstraintSet$Constraint;->mIsGuideline:Z
