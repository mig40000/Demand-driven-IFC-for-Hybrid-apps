...
.method chooseSubject(Landroid/support/constraint/solver/LinearSystem;)Landroid/support/constraint/solver/SolverVariable;
    ...
    .local v6, "i":I
    :goto_0
    iget v7, p0, Landroid/support/constraint/solver/ArrayVariables;->currentSize:I

    if-ge v6, v7, :cond_a

    .line 264
    iget-object v7, p0, Landroid/support/constraint/solver/ArrayVariables;->mArrayValid:[Z
    ...
    .line 267
    :cond_0
    iget-object v7, p0, Landroid/support/constraint/solver/ArrayVariables;->mArrayValues:[F
    ...
    .line 269
    .local v8, "epsilon":F
    iget-object v9, p0, Landroid/support/constraint/solver/ArrayVariables;->mCache:Landroid/support/constraint/solver/Cache;
    ...
    iget-object v10, p0, Landroid/support/constraint/solver/ArrayVariables;->mArrayIndices:[I
...
.method public final clear()V
    ...
    .line 166
    iget-object v1, p0, Landroid/support/constraint/solver/ArrayVariables;->mCache:Landroid/support/constraint/solver/Cache;
...
.method public final put(Landroid/support/constraint/solver/SolverVariable;F)V
    ...
    .end local v0    # "i":I
    :cond_2
    iget-object v0, p0, Landroid/support/constraint/solver/ArrayVariables;->mArrayIndices:[I
...
.method final updateFromRow(Landroid/support/constraint/solver/ArrayRow;Landroid/support/constraint/solver/ArrayRow;Z)V
    ...
    invoke-virtual {v1, v3}, Landroid/support/constraint/solver/SolverVariable;->removeFromRow(Landroid/support/constraint/solver/ArrayRow;)V

    .line 350
    :cond_2
    iget-object v1, p2, Landroid/support/constraint/solver/ArrayRow;->variables:Landroid/support/constraint/solver/ArrayLinkedVariables;

    check-cast v1, Landroid/support/constraint/solver/ArrayVariables;

    .line 351
    .local v1, "definitionVariables":Landroid/support/constraint/solver/ArrayVariables;
    const/4 v3, 0x0

    .local v3, "j":I
    :goto_1
    iget v4, v1, Landroid/support/constraint/solver/ArrayVariables;->currentSize:I
    ...
    iget-object v5, v1, Landroid/support/constraint/solver/ArrayVariables;->mArrayIndices:[I
    ...
    iget-object v5, v1, Landroid/support/constraint/solver/ArrayVariables;->mArrayValues:[F
    ...
    invoke-virtual {p0, v4, v6, p3}, Landroid/support/constraint/solver/ArrayVariables;->add(Landroid/support/constraint/solver/SolverVariable;FZ)V
    ...
    .line 336
    .end local v1    # "definitionVariables":Landroid/support/constraint/solver/ArrayVariables;
    .end local v2    # "value":F
    :cond_4
    :goto_2
    add-int/lit8 v0, v0, 0x1
...
.method updateFromSystem(Landroid/support/constraint/solver/ArrayRow;[Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 390
    .local v4, "definitionVariables":Landroid/support/constraint/solver/ArrayVariables;
    const/4 v5, 0x0
    ...
    .line 394
    .local v7, "definitionValue":F
    mul-float v8, v7, v3

    const/4 v9, 0x1

    invoke-virtual {p0, v6, v8, v9}, Landroid/support/constraint/solver/ArrayVariables;->add(Landroid/support/constraint/solver/SolverVariable;FZ)V

    .line 390
    .end local v6    # "definitionVariable":Landroid/support/constraint/solver/SolverVariable;
    .end local v7    # "definitionValue":F
    add-int/lit8 v5, v5, 0x1

    goto :goto_1

    .line 397
    .end local v4    # "definitionVariables":Landroid/support/constraint/solver/ArrayVariables;
    .end local v5    # "j":I
    :cond_1
    ...
    .line 398
    iget-object v4, v2, Landroid/support/constraint/solver/ArrayRow;->variable:Landroid/support/constraint/solver/SolverVariable;
