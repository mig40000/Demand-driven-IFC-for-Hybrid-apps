...
.method chooseSubject(Landroid/support/constraint/solver/LinearSystem;)Landroid/support/constraint/solver/SolverVariable;
    ...
    iget v11, v0, Landroid/support/constraint/solver/ArrayLinkedVariables;->currentSize:I

    if-ge v9, v11, :cond_8

    .line 516
    iget-object v11, v0, Landroid/support/constraint/solver/ArrayLinkedVariables;->mArrayValues:[F
    ...
    iget-object v14, v0, Landroid/support/constraint/solver/ArrayLinkedVariables;->mArrayIndices:[I
    ...
    invoke-virtual {v13, v15}, Landroid/support/constraint/solver/SolverVariable;->removeFromRow(Landroid/support/constraint/solver/ArrayRow;)V
    ...
    .line 533
    iget-object v15, v13, Landroid/support/constraint/solver/SolverVariable;->mType:Landroid/support/constraint/solver/SolverVariable$Type;
    ...
    .line 537
    invoke-direct {v0, v13, v1}, Landroid/support/constraint/solver/ArrayLinkedVariables;->isNew(Landroid/support/constraint/solver/SolverVariable;Landroid/support/constraint/solver/LinearSystem;)Z
    ...
    :cond_7
    :goto_2
    iget-object v14, v0, Landroid/support/constraint/solver/ArrayLinkedVariables;->mArrayNextIndices:[I
...
.method final updateFromRow(Landroid/support/constraint/solver/ArrayRow;Landroid/support/constraint/solver/ArrayRow;Z)V
    ...
    invoke-virtual {p0, v4, p3}, Landroid/support/constraint/solver/ArrayLinkedVariables;->remove(Landroid/support/constraint/solver/SolverVariable;Z)F
    ...
    invoke-virtual {p0, v7, v9, p3}, Landroid/support/constraint/solver/ArrayLinkedVariables;->add(Landroid/support/constraint/solver/SolverVariable;FZ)V
...
.method updateFromSystem(Landroid/support/constraint/solver/ArrayRow;[Landroid/support/constraint/solver/ArrayRow;)V
    ...
    invoke-virtual {p0, v3, v5}, Landroid/support/constraint/solver/ArrayLinkedVariables;->remove(Landroid/support/constraint/solver/SolverVariable;Z)F

    .line 634
    iget v6, v3, Landroid/support/constraint/solver/SolverVariable;->definitionId:I
    ...
    invoke-virtual {p0, v10, v12, v5}, Landroid/support/constraint/solver/ArrayLinkedVariables;->add(Landroid/support/constraint/solver/SolverVariable;FZ)V
    ...
    iget v5, v6, Landroid/support/constraint/solver/ArrayRow;->constantValue:F
    ...
    .line 649
    iget-object v2, v6, Landroid/support/constraint/solver/ArrayRow;->variable:Landroid/support/constraint/solver/SolverVariable;
