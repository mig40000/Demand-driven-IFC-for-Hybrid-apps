.class public Lcom/unity3d/ads2/configuration/EnvironmentCheck;
...
.method public static isEnvironmentOk()Z
    ...
    .prologue
    .line 14
    invoke-static {}, Lcom/unity3d/ads2/configuration/EnvironmentCheck;->testProGuard()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {}, Lcom/unity3d/ads2/configuration/EnvironmentCheck;->testCacheDirectory()Z
...
.method public static testProGuard()Z
    ...
    .line 19
    :try_start_0
    const-string v2, "com.unity3d.ads2.webview.bridge.WebViewBridgeInterface"
    ...
    .line 23
    invoke-static {v3}, Lcom/unity3d/ads2/configuration/EnvironmentCheck;->hasJavascriptInterface(Ljava/lang/reflect/Method;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-static {v2}, Lcom/unity3d/ads2/configuration/EnvironmentCheck;->hasJavascriptInterface(Ljava/lang/reflect/Method;)Z
    ...
    invoke-static {v2}, Lcom/unity3d/ads2/log/DeviceLog;->error(Ljava/lang/String;)V
    :try_end_0
