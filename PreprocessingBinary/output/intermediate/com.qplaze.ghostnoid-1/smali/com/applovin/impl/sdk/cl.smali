.class abstract Lcom/applovin/impl/sdk/cl;
...
.method constructor <init>(Ljava/lang/String;Lcom/applovin/impl/sdk/AppLovinSdkImpl;Ljava/util/List;Lcom/applovin/nativeAds/AppLovinNativeAdLoadListener;)V
    ...
    iput v0, p0, Lcom/applovin/impl/sdk/cl;->d:I

    iput-object p4, p0, Lcom/applovin/impl/sdk/cl;->a:Lcom/applovin/nativeAds/AppLovinNativeAdLoadListener;

    iput-object p3, p0, Lcom/applovin/impl/sdk/cl;->c:Ljava/util/List;
...
.method constructor <init>(Ljava/lang/String;Lcom/applovin/impl/sdk/AppLovinSdkImpl;Ljava/util/List;Lcom/applovin/nativeAds/AppLovinNativeAdPrecacheListener;)V
    ...
    iput-object p4, p0, Lcom/applovin/impl/sdk/cl;->b:Lcom/applovin/nativeAds/AppLovinNativeAdPrecacheListener;
...
.method private a(I)V
    ...
    iget-object v0, p0, Lcom/applovin/impl/sdk/cl;->a:Lcom/applovin/nativeAds/AppLovinNativeAdLoadListener;
...
.method protected a(Ljava/lang/String;Lcom/applovin/impl/sdk/y;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/applovin/impl/sdk/dm;->isValidString(Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_0

    iget-object v1, p0, Lcom/applovin/impl/sdk/cl;->f:Lcom/applovin/impl/sdk/AppLovinSdkImpl;

    invoke-virtual {v1}, Lcom/applovin/impl/sdk/AppLovinSdkImpl;->getLogger()Lcom/applovin/sdk/AppLovinLogger;

    move-result-object v1

    invoke-virtual {p0}, Lcom/applovin/impl/sdk/cl;->a()Ljava/lang/String;
    ...
    :cond_1
    :try_start_0
    iget-object v1, p0, Lcom/applovin/impl/sdk/cl;->h:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/applovin/impl/sdk/cl;->g:Lcom/applovin/sdk/AppLovinLogger;
    ...
    iget-object v2, p0, Lcom/applovin/impl/sdk/cl;->g:Lcom/applovin/sdk/AppLovinLogger;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/applovin/impl/sdk/cl;->c:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/applovin/impl/sdk/cl;->f:Lcom/applovin/impl/sdk/AppLovinSdkImpl;

    invoke-virtual {v2}, Lcom/applovin/impl/sdk/AppLovinSdkImpl;->getFileManager()Lcom/applovin/impl/sdk/y;
    ...
    invoke-virtual {p0, v0, v2}, Lcom/applovin/impl/sdk/cl;->a(Lcom/applovin/impl/sdk/NativeAdImpl;Lcom/applovin/impl/sdk/y;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget v2, p0, Lcom/applovin/impl/sdk/cl;->d:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lcom/applovin/impl/sdk/cl;->d:I

    invoke-virtual {p0, v0}, Lcom/applovin/impl/sdk/cl;->a(Lcom/applovin/impl/sdk/NativeAdImpl;)V
    ...
    iget-object v1, p0, Lcom/applovin/impl/sdk/cl;->c:Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lcom/applovin/impl/sdk/cl;->a(Ljava/util/List;)V
    ...
    sget-object v1, Lcom/applovin/impl/sdk/cb;->aF:Lcom/applovin/impl/sdk/cd;
    ...
    invoke-direct {p0, v0}, Lcom/applovin/impl/sdk/cl;->a(I)V
    :try_end_0
